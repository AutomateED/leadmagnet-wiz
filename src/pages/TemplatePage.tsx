...
export default function TemplatePage() {
  ...
  const SEO_DESC = 'A self-serve quiz funnel for business coaches. Turn website visitors into qualified leads automatically — set up in under an hour, no developer needed.';
