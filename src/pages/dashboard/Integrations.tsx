...
export default function Integrations({ config, onConfigChange, userId, quizId }: IntegrationsProps) {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-1" style={{ color: '#0F0A1E' }}>Connect your CRM</h1>
      <p className="mb-8" style={{ color: '#6B5F80' }}>
        Your leads are already saved to your Leads page automatically. You can export them as CSV any time. If you'd also like leads sent directly to your CRM, add your webhook URL below.
      </p>
